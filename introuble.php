...
<div class="w-container">
      <div class="w-row">
          <div class="team-box" style="margin-top: 10px;">
              <p class="team-info" style="margin-bottom:0px;">Every day we look at our open trades and if we see that a trade is in trouble, we issue a trade in trouble alert. Included with your alert you get a detailed adjustment to mitigate the risk with the goal of bringing it back to break even, back to a profit, or if the trade does not work anymore, we close the trade at a loss.</p>
        </div>
    </div>
 </div>
