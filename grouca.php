...
if(isset($_POST['Post'])) 
{
    ...
    {echo '<div style="color:red;">Please perform stock price lookup</div>';}
      ...
      $sql_insert =  mysql_query("INSERT INTO positions (Title, Status, Stock, Price, Sell, PriceSell, Sell2, PriceSell2, Buy, PriceBuy, Buy2, PriceBuy2, Gain, Loss, Margin, Notes, Date, Action, Trade, SetPrice) VALUES('" . $title . "','New', '" . $ticker . "', '" . $price. "','" . $sell . "','" . $price1 . "','" . $sell2 . "','" . $price2. "','" . $buy. "', '" . $price3. "','" . $buy2. "','" . $price4. "','" . $gain. "','" . $loss. "','" . $margin . "','" . $notes. "',CURRENT_TIMESTAMP,'" . $action. "','" . $trade. "','" . $setprice. "')") or die(mysql_error());
...
if(isset($_POST['Open'])) 
{
    ...
    $_SESSION['ID'] = $ID;
    include("connect.php");  
    $sql_search = mysql_query("SELECT * FROM (SELECT * FROM positions Where TradeID = '".$ID."' ORDER BY DATE DESC) AS foo GROUP BY TradeID");
