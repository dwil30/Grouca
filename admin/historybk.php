...
return date('n/j/Y', strtotime($date));
            ...
            while ($new = $sql_history->fetch_assoc()){
                ...
                $lines[] = array($new[Date],$new[Status],$new[Stock]." - ".$new[Price],$new[Action],$new[TargetGain],$new[MaxLoss],$new[Notes],$new[Type],$new[Number], $new[FullCode],$new[FullCode],$new[LowerPrice]);
