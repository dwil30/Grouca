...
$dbname = "grouca"; // the name of the database that you are going to use for this project
$dbuser = "groucaadmin"; // the username that you created, or were given, to access your database
$dbpass = "groucapass"; // the password that you created, or were given, to access your database
*/
