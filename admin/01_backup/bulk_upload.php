...
if(isset($_POST['submit'])){
  ...
  */
    ...
    $import_new = array_values($import);
    
    str_replace(".STK", "", $import);
    str_replace("Sel", "Sell", $import);
    ...
    foreach ($import as $key => $value){
        ...
        if (count($array) == 7){
            ...
            $datearray = $array[1].' '.$array[2].' '.$array[3];
            $new_date = date('ymd', strtotime('-2 day', strtotime($datearray)));
        }
    ...
    $_SESSION['temp'] = $import;   
    
    foreach($_SESSION['temp'] as $values){
        $_SESSION['final'][] = array_values($values);
    }
...
if(isset($_POST['final'])){
    ...
    foreach ($_SESSION['final'] as $val){
        ...
        if ($val[16] == 'New'){
            ...
            $query = "INSERT INTO positions (Status, IBStatus, Title, Stock, Price, Type, Number, Code, Letter, LowerPrice, UpperPrice, HighPrice, LetterCode, FullCode, Option, Option2, StockSymbol, IV, Gain, Loss, Margin, Notes, Action, Trade, Date, OptionSymbol, isCurrent) VALUES (
            'New','Unprocessed','". $val[17]. "','". $val[12]. "','". $val[14]. "','". $val[1]. "','". $val[2]. "','". $val[3]. "','". $val[4]. "','". $val[5]. "','". $val[6]. "','". $val[7]. "','". $val[8]. "','". $val[9]. "','". $val[10]. "','". $val[11]. "','". $val[12]. "','". $val[13]. "','". $val[18]. "','". $val[19]. "','". $val[20]. "','". $val[21]. "','". $val[22]. "','". $val[23]. "','". $val[0]. "','". $val[15]. "','1');";
        ...
        elseif (($val[16] != 'New')&&(($val[16] != 'Ignore'))) { 
                ...
                $query = "INSERT INTO positions (TradeID, Status, IBStatus, Title, Stock, Price, Type, Number, Code, Letter, LowerPrice, UpperPrice, HighPrice, LetterCode, FullCode, Option, Option2, StockSymbol, IV, Gain, Loss, Margin, Notes, Action, Trade, Date, OptionSymbol, isCurrent) VALUES ( '". $val[16]. "','". $val[24]. "','Unprocessed','". $val[17]. "','". $val[12]. "','". $val[14]. "','". $val[1]. "','". $val[2]. "','". $val[3]. "','". $val[4]. "','". $val[5]. "','". $val[6]. "','". $val[7]. "','". $val[8]. "','". $val[9]. "','". $val[10]. "','". $val[11]. "','". $val[12]. "','". $val[13]. "','". $val[18]. "','". $val[19]. "','". $val[20]. "','". $val[21]. "','". $val[22]. "','". $val[23]. "','". $val[0]. "','". $val[15]. "','1');";
                    
                //$insert =  $mysqli->query($query);
                    
                if ($sent2 == 0){include('send-adjustment.php');$sent2++;}
