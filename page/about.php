		...
		<div class="main">
			...
			<div class="layout-p-50x50 clear-fix">
				...
				<div class="column-right">
                    ...
                    <p class="mobile" >As a leading provider of options trading strategies, Grouca's makes it easy for you to instantly trade options, even on-the-go, with confidence.   <br><br>

We have developed a system that zeroes in on option trades with the highest statistical odds of success and pre-packaged for one click submital. <br><br>

This innovative technology leveraged with our expertise in the field, means that by the time someone hears about a potential opportunity, we’ve already generate a winning trade.</p>
					...
					<div class="carousel-content">
						...
						<ul class="feature-list feature-list-style-2 feature-list-icon-large feature-list-icon-top clear-fix layout-p-25x25x25x25">
							...
							<li class="column-left">
								...
								<p style="font-size:105%; color:white;">Enter your email and phone number for instant access to winning trades, then pick a password and you’re ready to go.</p>
							</li>
							<!-- /Entry #1 -->
							...
							<li class="column-center-left">
								...
								<p style="font-size:105%">The moment a high probability trade surfaces, current trades become profitable or when it’s time to make an adjustment, you’ll be notified via cms and email, right away.</p>
							</li>
							<!-- /Entry #2 -->
							...
							<li class="column-center-right">
								...
								<h4>Take Action in Seconds</h4>
								<p style="font-size:105%">No matter whether, you’re placing a new trade or re-balancing an open one, one click takes your trade to your broker, with minimal interruption to your day.</p>
							</li>
							<!-- /Entry #3 -->
