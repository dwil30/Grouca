		...
		<div class="main">
			...
			<div class="layout-p-50x50 clear-fix">
				...
				<div class="column-right">
					...
					<p>
					Enter your email and phone number for instant access to winning trades, then pick a password and you’re ready to go.
					</p>
                    
                    <h3 style="font-size:30px;">Get Instant Alerts</h3>
					
					<p>
					The moment a high probability trade surfaces, current trades become profitable or when it’s time to make an adjustment, you’ll be notified via cms and email, right away.
					</p>
                    
                    <h3 style="font-size:30px;">Take Action in Seconds</h3>
					
					<p>
					No matter whether, you’re placing a new trade or re-balancing an open one, one click takes your trade to your broker, with minimal interruption to your day.
					</p>
					...
					<div class="carousel-content">
						...
						<ul class="feature-list feature-list-style-2 feature-list-icon-large feature-list-icon-top clear-fix layout-p-25x25x25x25">
							...
							<li class="column-left">
								...
								<h4>Free Sign Up</h4>
								<p style="font-size:105%">Enter your email and phone number for instant access to winning trades, then pick a password and you’re ready to go.</p>
							</li>
							<!-- /Entry #1 -->
							...
							<li class="column-center-left">
								...
								<p style="font-size:105%">The moment a high probability trade surfaces, current trades become at risk or when it’s time to make an adjustment, you’ll be notified via phone and email, right away.</p>
							</li>
							<!-- /Entry #2 -->
							...
							<li class="column-center-right">
								...
								<h4>Action In Seconds</h4>
								<p style="font-size:105%">No matter whether, you’re placing a new trade or rebalancing an open one, one click takes you to your broker, with minimal interruption to your day.</p>
							</li>
							<!-- /Entry #3 -->
