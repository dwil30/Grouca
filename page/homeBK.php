		...
		<div class="home-carousel-box-new" style="height:100%; background-image: url('_sample/home_carousel/image_02.jpg');">
			...
			<ul class="home-carousel update-carousel-disable">
						...
						<div class="home-carousel-title-box">
							<div class="main">
								<a href="#about" class="home-carousel-title-box">
									<span>
										<!-- Title -->
                                        <span>GET DATA-DRIVEN OPTION TRADES</span>
						...
						<div class="home-carousel-title-box">
							<div class="main">
								<a href="#about" class="home-carousel-title-box">
									<span>
										<!-- Title -->
                                        <span>SUBMIT STRATEGY IN A SINGLE CLICK</span>
                ...
                <li>
						...
						<div class="home-carousel-title-box">
							<div class="main">
								<a href="#about" class="home-carousel-title-box">
									<span>
										<!-- Title -->
                                        <span>MODELED FOR 25% + RETURNS</span>
                   ...
                   <li>
					<div>
						<!-- Image -->
						<img src="_sample/home_carousel/image_04.jpg" alt=""/>
						<!-- /Image -->
						<div class="home-carousel-title-box">
							<div class="main">
								<a href="#about" class="home-carousel-title-box">
