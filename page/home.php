								...
								<div class="home-carousel-title-box" style="position:relative;margin:auto;left:0%;">
									<span>
										...
										<!--<span>Request your free video</span>-->
                                         ...
                                         <form id="videoForm" method="POST" action="#" style="width:400px;margin:auto;margin-top:25px;background-color:transparent;">
                                             
                                             <input type="text" id="email" name="email" class="w-input" placeholder="Email Address..." required style="height: 50px;text-align: center;background-color: #15A346;">
