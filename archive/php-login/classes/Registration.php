...
class Registration
{
    ...
    private function registerNewUser()
    {
        ...
        if (empty($_POST['user_password_new']) || empty($_POST['user_password_repeat'])) {
            ...
            $this->errors[] = "Captcha does not match. Please try again.";
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                if ($query_check_user_name->num_rows == 1) {
                    ...
                    $sql = "INSERT INTO users (user_password_hash, user_email, JoinDate)
                            VALUES('" . $user_password_hash . "', '" . $user_email . "',CURDATE());";
