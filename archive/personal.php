      ...
      <div class="w-col w-col-5">
        <div class="w-container right-container">
          <div>
            ...
            <form method="post" action="adduser.php" name="registerform">
        <input type="email" class="w-input email-text" id="login_input_email" placeholder="Email Address" name="user_email" required >
        <input type="password" class="w-input email-text" id="login_input_password_new" placeholder="Password" name="user_password_new" required>
        <input type="password" class="w-input email-text" id="login_input_password_repeat" placeholder="Confirm Password" name="user_password_repeat" required>
