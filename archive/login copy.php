...
?>
    ...
    <input type="submit"  name="login" value="Log in" />
                ...
                <input type="email" class="nav-email" id="login_input_username" placeholder="EMAIL" name="user_name"  value="<?php echo $_POST['user_name'];?>" required><br>
                <input type="password" class="nav-email" id="login_input_password" placeholder="PASSWORD" name="user_password" value="<?php echo $_POST['user_password'];?>" required><br>
                <input type="submit" class="nav-email nav-continue" name="login" value="Log In">
            </form>--></center><br>                
