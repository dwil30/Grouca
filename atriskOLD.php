    ...
    <div class="w-container">
      <div class="w-row">
          <div class="team-box" style="margin-top: 10px;">
              <p class="team-info" style="margin-bottom:0px;">Every day we look at our open trades and if we see that a trade has become unbalanced we issue a trade at risk alert. Included with your alert you get a detailed adjustment to rebalance your trade.</p>
        </div>
          </div>
