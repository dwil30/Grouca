<?php
		...
		require_once('../../library/class/Template.class.php');
		...
		(
			...
			'contact-form-website'					=> $_POST['contact-form-website'],
		...
		{
			$response['error']=1;	
			$response['info'][]=array('fieldId'=>'contact-form-submit','message'=>CONTACT_FORM_SEND_MSG_ERROR);
			createResponse($response);		
		}

		$response['error']=0;
		$response['info'][]=array('fieldId'=>'contact-form-submit','message'=>CONTACT_FORM_SEND_MSG_OK);
