...
window.location.replace("https://www.grouca.com/signupforgrouca.php");
}
...
var Var = t.split('|');    
    for (index = 0; index < Var.length; ++index) {
        ...
        if (Var[index]) {
		 ...
		 document.getElementById("errorCode" + Var[index]).setAttribute('style', 'display:block !important');
		 }
    }
}
    
function completeCREPayment(transaction){
window.location.replace("https://www.grouca.com/success.php");
}
